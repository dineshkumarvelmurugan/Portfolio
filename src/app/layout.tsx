...
export const metadata: Metadata = {
  title: 'Dineshkumar | Portfolio',
  description:
    'Check out modern and stylish porfolio of an experienced Web Developer Dineshkumar! Built using TypeScript, Next.js 14, Framaer Motion and Tailwind CSS.',
};
