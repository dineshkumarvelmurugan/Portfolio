             ...
             >
              ...
              <div className="flex gap-2">
                <a
                  ...
                  href="https://www.linkedin.com/in/dineshkumar-v-987565259/"
                  target="_blank"
                >
                  <Linkedin />
                </a>
                <a
                  className="borderBlack flex h-[50px] w-[50px] cursor-pointer items-center justify-center gap-2 rounded-full bg-black p-2 text-gray-700 transition hover:bg-gray-100 hover:text-gray-950 dark:bg-white/10 dark:text-white/60 dark:hover:bg-white/20"
                  href="https://github.com/dineshkumarvelmurugan"
                  target="_blank"
                >
                  <Image
                    width={25}
